...
node {
 ...
 rtMaven.tool = "maven"
    ...
    stage ('DeployToProd') {
                   sh 'curl -v -u jenkins:jenkins -T /var/lib/jenkins/workspace/MarsLander_Pipeline/target/JavaWebApp-1.0-SNAPSHOT.war "http://18.191.247.103:8080/manager/text/deploy?path=/QAWebapp&update=true"'
          }
